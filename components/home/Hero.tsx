...
const Hero: React.FC = () => {
  ...
  const locations = ["Rest Well, Work Better — Rooms Redefined.", "Chennai, Bengaluru, Ooty, Hosur and more..."];
    ...
    <div className={styles.heroContent} id="home">
      <div className={`${styles.welcomeToParent} fade-in-element`}>
        ...
        <p className={`${styles.hotelDescription} ${styles.fadeSlideDelay2}`}>
          Experience unparalleled luxury and comfort at Al Noor Group of Hotels. Our
  ...
  <span className={styles.placeholder}>Now in Bengaluru</span> {/* Invisible placeholder */}
